...
const aboutAdvantages: AboutAdvantage[] = [
  {
    index: "01",
    title: "Полный цикл",
    text: "Берём на себя бриф, концепцию, съёмку, монтаж, цвет, звук и финальные версии без разрыва между этапами.",
  },
  {
    index: "02",
  ...
  },
  {
    ...
    text: "Следим за кадром, светом, ритмом, цветом и постпродакшном как за одной системой.",
  },
  {
    index: "04",
    title: "Процесс без хаоса",
    text: "Понятный маршрут проекта, спокойная коммуникация и подготовка, которая экономит время на площадке.",
  },
  {
    index: "05",
    title: "Видео под задачу",
    text: "Думаем не только о красоте кадра, но и о том, как ролик работает на бренд, продукт или событие.",
  },
];
...
const aboutFaqItems: AboutFaqItem[] = [
  {
    ...
    a: "Это работа в одном контуре: от брифа, идеи и подготовки до съёмки, монтажа, цветокоррекции, графики, звука и выпуска финальных версий.",
  },
  {
